function hvectors = quiverpsn(lat,lon,u,v,varargin)
% quiverpsn plots georeferenced vector fields on a northern-hemisphere polar
% stereographic map. 
% 
...
%% Syntax 
% 
%  quiverpsn(lat,lon,u,v)
%  quiverpsn(...,'scale',scale)
%  quiverpsn(...,'inpaintnans',true) 
%  quiverpsn(...,'QuiverProperty',Value,...)
%  quiverpsn(...,'km') 
%  h = quiverpsn(...) 
% 
%% Description 
% 
% quiverpsn(lat,lon,u,v) plots zonal (u, eastward) and meridional (v, northward) components of
% a velocity field at geo locations lat,lon. 
%
% quiverpsn(...,'scale',scale) scales the density of the plotted vector field. The scale value 
...
% 
% quiverpsn(...,'inpaintnans',true) fixes edge effects near NaN holes. This option fills regions
...
% 
% quiverpsn(...,'QuiverProperty',Value,...) specifies any quiver properties such as color, linewidth, 
% etc. 
%
% quiverpsn(...,'km') plots in polar stereographic kilometers rather than the default meters. 
% 
% h = quiverpsn(...) returns a handle h of the graphics object. 
% 
...
[vx,vy] = uv2vxvyn(lattmp,lontmp,u,v); 
